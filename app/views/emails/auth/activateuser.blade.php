...
<title>CloudBI Projects - Forgot Assistance</title>
<style type="text/css">
			...
			<table width="580"  class="deviceWidth" border="0" cellpadding="0" cellspacing="0" align="center">
                ...
                <tr>
                    <td style="font-size: 13px; color: #959595; font-weight: normal; text-align: left; font-family: Helvetica, Arial, sans-serif; line-height: 24px; vertical-align: top; padding:25px 0">
                        <a href="#" style="text-decoration: none; color: #272727; font-size: 18px; color: #272727; font-weight: bold; ">Invitation to Join CloudBI Projects</a><br><br/>
                        Hi there (Sorry we don't know your name yet!) , <br/>
						You have been invited to join CloudBI Projects. Please <b style="color: #5b5b5b;"><a href={{$link}} style="text-decoration:none; color:black;">click here</a></b> to get started. <br/>
