...
<title>CloudBI Projects - Email Verification</title>
<style type="text/css">
			...
			<table width="580"  class="deviceWidth" border="0" cellpadding="0" cellspacing="0" align="center">
                ...
                <tr>
                    <td style="font-size: 13px; color: #959595; font-weight: normal; text-align: left; font-family: Helvetica, Arial, sans-serif; line-height: 24px; vertical-align: top; padding:25px 0">
                        ...
                        Hi {{ $name }}, <br/>
						You have change your email address on CloudBI Projects. We need to make sure that you haven't made any typo errors.  Please <b style="color: #5b5b5b;"><a href={{$link}} style="text-decoration:none; color:black;">click here</a></b> to verify your new email. <br/>
