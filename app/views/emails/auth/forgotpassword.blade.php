			...
			<table width="580"  class="deviceWidth" border="0" cellpadding="0" cellspacing="0" align="center">
                ...
                <tr>
                    <td style="font-size: 13px; color: #959595; font-weight: normal; text-align: left; font-family: Helvetica, Arial, sans-serif; line-height: 24px; vertical-align: top; padding:25px 0">
                        ...
                        Hi {{ $name }}, <br/>
						We have been told that you have forgot your password on CloudBI Projects. It happens. Dont worry, we have got it all covered. Please <b style="color: #5b5b5b;"><a href={{$link}} style="text-decoration:none; color:black;">click here</a></b> to reset your password. <br/>
