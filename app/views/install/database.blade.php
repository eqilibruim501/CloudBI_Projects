...
<title>CloudBI Projects - Installation Database</title>
<!-- CSS -->
            ...
            <div class="field_main">
              ...
              <div class="row-fluid field_data">
               ...
               <div class="row-fluid field_data">
                ...
                <div class="span5">
                  <input type="password" id="password" name="password" class="span12 field_input" placeholder="password" data-required="true"  data-show-errors="true">
                </div>
              </div>
